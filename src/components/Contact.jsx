...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_fy2fkdf', // paste your ServiceID here (you'll get one when your service is created).
        'template_4adx1mq', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
        ...
        'tWLfHtBPePpYZg9zt' //paste your Public Key here. You'll get it in your profile section.
      )
      .then(
        () => {
          setLoading(false);
